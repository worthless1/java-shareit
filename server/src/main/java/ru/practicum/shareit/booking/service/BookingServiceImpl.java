...
public class BookingServiceImpl implements BookingService {
    ...
    @Override
    public List<BookingAnswerDto> getAllBookingsByUser(Long userId, State bookingState, Integer from, Integer size) {
        getUserById(userId);
    ...
    @Override
    public List<BookingAnswerDto> getAllBookingsAllItemsByOwner(Long ownerId, State bookingState, Integer from, Integer size) {
        getUserById(ownerId);
        PageRequest pageRequest = PaginationMapper.toPage(from, size);
