...
class BookingServiceImplTest {
    ...
    void testGetAllBookingsByUser() {
        ...
        List<BookingAnswerDto> result = bookingService.getAllBookingsByUser(userId, state, from, size);
    ...
    @Test
    void testConvertToStateBookingWithInvalidState() {
        assertThrows(UnsupportedStatusException.class, () -> bookingService.convertToStateBooking("INVALID_STATE"));
    }
